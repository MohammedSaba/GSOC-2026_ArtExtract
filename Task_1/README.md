 ...
 **training split only** (style_train.csv: 57,025 images; artist_train.csv:
 ...
 train and validation splits together. Both figures are correct — they measure
 different things. Architecture decisions were made on the training split only,
 since validation data is unseen during design.
